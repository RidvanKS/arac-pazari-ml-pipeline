...
def render_car_svg(parca_durumlari):
    ...
    <style>
        ...
        svg path {{ transition: all 0.2s ease; }}
        .car-legend {{
            display: flex;
      ...
      <svg version="1.1" style="height:380px;width:100%;display:block;margin:auto;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 430">
        ...
        <g fill="none" fill-rule="evenodd">
          <g transform="translate(156.5 219.5) rotate(-90) translate(-188.5 -144.5)">
            ...
            <path data-parca="sol_on_kapi" {click_attrs('sol_on_kapi')}
                  ...
                  {part_title('sol_on_kapi')}
            </path>

            <path data-parca="sol_arka_kapi" {click_attrs('sol_arka_kapi')}
                  ...
                  {part_title('sol_arka_kapi')}
            </path>

            <path data-parca="on_tampon" {click_attrs('on_tampon')}
                  ...
                  {part_title('on_tampon')}
            </path>

            <path data-parca="sol_on_camurluk" {click_attrs('sol_on_camurluk')}
                  ...
                  {part_title('sol_on_camurluk')}
            </path>

            <path data-parca="sag_on_camurluk" {click_attrs('sag_on_camurluk')}
                  ...
                  {part_title('sag_on_camurluk')}
            </path>

            <path data-parca="sag_arka_camurluk" {click_attrs('sag_arka_camurluk')}
                  ...
                  {part_title('sag_arka_camurluk')}
            </path>

            <path data-parca="sag_on_kapi" {click_attrs('sag_on_kapi')}
                  d="m114.9 247.46l0.047425 0.098276c2.2764 3.9311 5.1693 7.4199 8.5838 10.319 1.7547 1.4741 3.2723 3.1448 4.5053 4.9138 1.233 1.7198 1.897 3.1448 2.6084 4.619 0.61652 1.2285 1.233 2.5552 2.229 4.1767 0.99592 1.5724 2.0867 3.0957 3.2723 4.5207 1.5176 1.8181 3.462 2.8992 5.3115 2.9483 2.4661 0.049138 5.8806 0.049138 10.196 0.049138 5.5961 0 11.287-0.049138 13.706-0.049138v-25.847c0-7.3707-0.66394-14.741-1.9918-21.965l-3.13-17.248h-13.469c-10.813 0-21.578 2.7517-31.158 7.9113l-4.6476 2.506c-2.2764 1.2285-3.9362 3.2431-4.7899 5.7492-0.33197 0.98276-0.1897 2.0638 0.33197 2.9974l8.3941 14.299z"
                  fill="{renk('sag_on_kapi')}" stroke="#374151" stroke-width="0.5">
                  {part_title('sag_on_kapi')}
            </path>

            <path data-parca="sag_arka_kapi" {click_attrs('sag_arka_kapi')}
                  d="m169.03 253.22v25.886h57.66c0.85493 0 1.6149-0.63976 1.7574-1.5256l0.28498-1.7224c1.8049-11.811 1.0449-24.065-2.1848-35.531-1.1399-3.9862-3.6572-7.3819-7.0769-9.5472-15.911-9.9409-34.055-15.65-52.531-16.634l-2.9448-0.14764 3.0398 16.732c1.3299 7.3819 1.9948 14.961 1.9948 22.49z"
                  fill="{renk('sag_arka_kapi')}" stroke="#374151" stroke-width="0.5">
                  {part_title('sag_arka_kapi')}
            </path>

            <path data-parca="sol_arka_camurluk" {click_attrs('sol_arka_camurluk')}
                  ...
                  {part_title('sol_arka_camurluk')}
            </path>

            <path data-parca="kaput" {click_attrs('kaput')}
            ...
            <path data-parca="bagaj_kapagi" {click_attrs('bagaj_kapagi')}
                  ...
                  {part_title('bagaj_kapagi')}
            </path>

            <path data-parca="tavan" {click_attrs('tavan')}
...
# SVG göster (components.html ile — tam HTML render eder)
    components.html(render_car_svg(st.session_state.parca_durumlari), height=480, scrolling=False)
